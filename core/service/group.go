...
// GetDiscordEligibleGroupsForUser returns the IDs of all groups whose
// Discord role bindings are satisfied by userRoles. Groups with no
// bindings are not included.
func GetDiscordEligibleGroupsForUser(userRoles []string) ([]string, error) {
	var bindings []model.GroupDiscordRoleBinding
