...
func Init() {
	...
	if err != nil {
		...
		db.AutoMigrate(&model.Entity{}, &model.EntityEmail{}, &model.EntityPhone{}, &model.EntityExternalAuth{}, &model.PhoneLoginCode{}, &model.EmailLoginCode{}, &model.Token{}, &model.ApplicationGroup{})
