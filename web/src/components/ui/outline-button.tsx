    ...
    return (
      <div>
        <button
          ...
          className={cn(
            className,
            "group relative inline-flex items-center justify-center overflow-hidden  rounded-md bg-gradient-to-br  from-gr-pink to-gr-purple p-0.5 text-sm font-medium text-white",
          )}
        >
